...
class ScrapeBot
	...
	def get_company_id(results_page)
		id = results_page.parser.css('.company-header-info').inner_html
		id = id.match(/Dice Id : (\d*)/)
		return "Company ID: #{id[0]}"
	end
